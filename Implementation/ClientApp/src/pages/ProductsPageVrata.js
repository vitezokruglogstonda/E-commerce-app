...
const [tipProzivoda, settipProzivoda] = useState("Vrata");
  ...
  useEffect(() => {
    const fetchData = async () => {
      const filter = {
        ...
        var url = `https://localhost:5001/API/PreuzmiSveProizvode/Vrata/${sortOrder}/${pageNumber}/${pageSize}`;
...
export default ProductsPageVrata
