...
const AdminNeodobreniKomentari = () => {
    var columns = [
        { title: "id", field: "id"},
    ...
    useEffect(() => {
        const fetchData = async () => {
            axios.get(`https://localhost:5001/Admin/PreuzmiNeodobreneKomentare/`,
                {
                    headers: authHeader()
                }
            ).then(response => {
    ...
    const handleRowOdobri = (oldData, resolve) => {
        ...
        axios.put(`https://localhost:5001/Admin/OdobriKomentar/{id}/${oldData.id}`,null,
            {
                headers: authHeader()
            }
        ).then(response => {
            ...
            style={{ padding: '20px' }}
              ...
              localization={{
                ...
                body: {
                    ...
                    editRow: { 
                        deleteText: 'Da li zelite da odobrite ovaj komentar?',
                        saveTooltip:'Da',
                        cancelTooltip:'Ne'
                    },
                    emptyDataSourceMessage: 'Trenutno nema nijedan neodobren komentar.',
                    filterRow: {
...
export default AdminNeodobreniKomentari;