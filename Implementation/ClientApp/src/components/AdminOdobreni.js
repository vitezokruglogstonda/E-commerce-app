...
const AdminOdobreni = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            axios.get(`https://localhost:5001/Api/PreuzmiSveProizvode/`,
                {
                    headers: authHeader()
                }
            ).then(response => {
    ...
    const handleRowDelete = (oldData, resolve) => {
        ...
        axios.delete(`https://localhost:5001/Admin/IzbrisiProizvod/${oldData.id}`,
            {
                headers: authHeader()
            ...
            style={{ padding: '20px' }}
              ...
              localization={{
                ...
                body: {
                    ...
                    editRow: { 
                        deleteText: 'Da li zelite da obrisete ovaj proizvod?',
                        saveTooltip:'Da',
                        cancelTooltip:'Ne'
                    },
                    emptyDataSourceMessage: 'Trenutno nema nijedan odobren proizvod.',
                    filterRow: {
